...
public class OpenFoodEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (OpenFoodEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = OpenFoodEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new OpenFoodEntity(addr, OpenFoodEntity_Type.this);
                    OpenFoodEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new OpenFoodEntity(addr, OpenFoodEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = OpenFoodEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.ontology.OpenFoodEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.ontology.OpenFoodEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.ontology.OpenFoodEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.ontology.OpenFoodEntity");
     ...
     * @generated
     */
    public OpenFoodEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
