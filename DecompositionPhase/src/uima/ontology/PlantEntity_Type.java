...
public class PlantEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (PlantEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = PlantEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new PlantEntity(addr, PlantEntity_Type.this);
                    PlantEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new PlantEntity(addr, PlantEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = PlantEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.ontology.PlantEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.ontology.PlantEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.ontology.PlantEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.ontology.PlantEntity");
     ...
     * @generated
     */
    public PlantEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
