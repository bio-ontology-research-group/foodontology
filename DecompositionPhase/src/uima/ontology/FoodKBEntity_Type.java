...
public class FoodKBEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (FoodKBEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = FoodKBEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new FoodKBEntity(addr, FoodKBEntity_Type.this);
                    FoodKBEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new FoodKBEntity(addr, FoodKBEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = FoodKBEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.ontology.FoodKBEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.ontology.FoodKBEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.ontology.FoodKBEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.ontology.FoodKBEntity");
     ...
     * @generated
     */
    public FoodKBEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
