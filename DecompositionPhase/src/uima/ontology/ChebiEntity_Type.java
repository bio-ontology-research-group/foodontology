...
public class ChebiEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (ChebiEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = ChebiEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new ChebiEntity(addr, ChebiEntity_Type.this);
                    ChebiEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new ChebiEntity(addr, ChebiEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = ChebiEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.ontology.ChebiEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.ontology.ChebiEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.ontology.ChebiEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.ontology.ChebiEntity");
     ...
     * @generated
     */
    public ChebiEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
