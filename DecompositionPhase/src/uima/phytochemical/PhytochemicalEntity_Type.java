...
public class PhytochemicalEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (PhytochemicalEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = PhytochemicalEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new PhytochemicalEntity(addr, PhytochemicalEntity_Type.this);
                    PhytochemicalEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new PhytochemicalEntity(addr, PhytochemicalEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = PhytochemicalEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.ontology.PhytochemicalEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.ontology.PhytochemicalEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.ontology.PhytochemicalEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.ontology.PhytochemicalEntity");
     ...
     * @generated
     */
    public PhytochemicalEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
