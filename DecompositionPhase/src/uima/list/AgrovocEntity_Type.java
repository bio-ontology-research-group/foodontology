...
public class AgrovocEntity_Type extends Annotation_Type {
    /** @generated */
    ...
    private final FSGenerator fsGenerator = new FSGenerator() {
        public FeatureStructure createFS(int addr, CASImpl cas) {
            if (AgrovocEntity_Type.this.useExistingInstance) {
                // Return eq fs instance if already created
                FeatureStructure fs = AgrovocEntity_Type.this.jcas.getJfsFromCaddr(addr);
                if (null == fs) {
                    fs = new AgrovocEntity(addr, AgrovocEntity_Type.this);
                    AgrovocEntity_Type.this.jcas.putJfsFromCaddr(addr, fs);
                    return fs;
                }
                return fs;
            }
            else return new AgrovocEntity(addr, AgrovocEntity_Type.this);
        }
    };

    /** @generated */
    public final static int typeIndexID = AgrovocEntity.typeIndexID;

    /**
     * @generated
     * @modifiable
     */
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("uima.list.AgrovocEntity");
    ...
    public String getStem(int addr) {
        if (featOkTst && casFeat_stem == null) jcas.throwFeatMissing("stem", "uima.list.AgrovocEntity");
    ...
    public String getIri(int addr) {
        if (featOkTst && casFeat_iri == null) jcas.throwFeatMissing("iri", "uima.list.AgrovocEntity");
    ...
    public String getWord(int addr) {
        if (featOkTst && casFeat_word == null) jcas.throwFeatMissing("word", "uima.list.AgrovocEntity");
     ...
     * @generated
     */
    public AgrovocEntity_Type(JCas jcas, Type casType) {
        super(jcas, casType);
